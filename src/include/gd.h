...
/* EK: gdImageString/gdImageStringUp functions with  justify flags */
/*
 flCmd
...
BGD_DECLARE(void) gdImageDrawText(gdImagePtr im, gdFontPtr f, int x, int y, unsigned char *s, int color, int flCmd );
BGD_DECLARE(void) gdImageDrawTextUp(gdImagePtr im, gdFontPtr f, int x, int y, unsigned char *s, int color, int flCmd );
